...
checks = [
    ...
    ("parquet/movilidad/atestados_acc.parquet", 50000, 2016, "accidentes"),
    ("parquet/movilidad/atestados_her.parquet", 30000, 2016, "heridos"),
    ("parquet/movilidad/atestados_veh.parquet", 100000, 2016, "vehiculos"),
